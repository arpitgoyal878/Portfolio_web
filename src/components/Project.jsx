...
const Project = () => {
  return (
    <>
              ...
              <picture className={index % 2 === 0 ? 'w-full md:w-6/12 shadow-lg ' : 'w-full md:w-6/12 shadow-lg md:order-1'}>
                <source
                  srcSet={`${project.image}-1280.png 1920w,
                        ${project.image}-768.png 768w,
                        ${project.image}-320.png 320w`}
      ...
      <div className='mx-5'>
        <a href='https://github.com/arpitgoyal878' target='_blank' rel='noreferrer' className='bg-gray block shadow-lg uppercase border border-gray-500 rounded-lg text-center my-12 p-2 max-w-xs m-auto'>
