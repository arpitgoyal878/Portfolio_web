  ...
  return (
    <section className="my-28" id="contact">
      <header className="px-5 text-2xl font-bold pt-10">
        <h2>Contact Me</h2>
        <p className="text-base font-thin">I love to hear your thoughts!</p>
      </header>
      <div className="md:mx-6 flex flex-col flex-wrap md:flex-row justify-between">
        <div className="md:w-6/12 md:px-0 p-5 my-5">
          <div>
            <p className="font-bold">Arpit Goyal</p>
            <a
              href="mailto: arpitgoyal878@gmail.com"
              className="border-b-2 mt-3 inline-block border-gray-500"
            >
              arpitgoyal878@gmail.com
            </a>
          </div>
          <a
            className="border-b-2 mt-3 inline-block border-gray-500"
            href="./Resume - Arpit Goyal.pdf"
            target="_blank"
            rel="noreferrer"
          >
            Resume
          ...
          <div className="flex flex-row flex-wrap mt-7">
            <div className="mr-4">
              <a
                href="https://www.linkedin.com/in/arpit-goyal-69526121a/"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="mr-4">
              <a
                href="https://github.com/arpitgoyal878"
                target="_blank"
                rel="noreferrer"
              >
                <span className="mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm">
            ...
            <a href="https://codepen.io/arpitgoyal878" target="_blank" rel="noreferrer">
              <span className="mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm">
                <img
